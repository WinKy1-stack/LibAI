...
export const adminBooks: AdminBook[] = [
  ...
  {
    id: "B-2011",
    title: "Phát Triển Web Với React 19",
    isbn: "978-6047771123",
    author: "Ngô Đức Kiên",
    category: "Công nghệ",
    publishedYear: 2025,
    ...
    overdueCount: 0,
    status: "available",
    lastActivity: "2025-10-25T08:22:00Z",
    format: "ebook",
  ...
  },
  {
    ...
    overdueCount: 1,
    status: "available",
    lastActivity: "2025-10-24T02:30:00Z",
    format: "hardcover",
    tags: ["Blockchain", "Fintech"],
  },
  {
    id: "B-2013",
    title: "Chiến Lược Quản Lý Nhân Sự Hiệu Quả",
    isbn: "978-6046677711",
    author: "Hoàng Bảo Trâm",
    category: "Kinh tế",
    publishedYear: 2022,
    totalCopies: 18,
    availableCopies: 6,
    ...
    overdueCount: 0,
    status: "loaned",
    lastActivity: "2025-10-24T13:00:00Z",
    format: "paperback",
  },
  {
    id: "B-2014",
    title: "Phân Tích Thống Kê Với Python",
    isbn: "978-6046679922",
    author: "Đặng Hoài An",
    category: "Công nghệ",
    publishedYear: 2023,
    ...
    overdueCount: 2,
    status: "loaned",
    lastActivity: "2025-10-25T09:45:00Z",
    format: "ebook",
  },
  {
    id: "B-2015",
  ...
  },
  {
    ...
    overdueCount: 1,
    status: "loaned",
    lastActivity: "2025-10-24T21:20:00Z",
    format: "hardcover",
  },
];
...
export const latestBookActivities: Array<{ id: string; title: string; action: string; timestamp: string }> = [
  ...
  { id: "B-2014", title: "Phân Tích Thống Kê Với Python", action: "Được thêm vào danh sách đề xuất", timestamp: "Hôm nay" },
];