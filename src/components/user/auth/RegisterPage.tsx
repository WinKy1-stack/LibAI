    ...
    <div className="relative flex min-h-screen max-h-screen overflow-hidden bg-black dark:bg-white">
      ...
      <div className="flex-1 flex items-center justify-center bg-gradient-to-b from-gray-900 to-black dark:from-gray-50 dark:to-gray-100 p-6 md:p-12">
        <div className="w-full max-w-[420px] px-5">
          <h1 className="text-[30px] font-extrabold text-white dark:text-gray-900 mb-3">Tạo tài khoản</h1>
          <p className="text-base text-gray-400 dark:text-gray-500 mb-8">
            Đã có tài khoản?{' '}
            <Link to="/login" className="text-purple-500 dark:text-purple-600 font-semibold hover:text-purple-400 dark:hover:text-purple-700 transition-colors">Đăng nhập</Link>
          </p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <label className="flex items-start gap-2 cursor-pointer text-gray-400 dark:text-gray-600 text-sm">
              <input
                type="checkbox"
                checked={agreedToTerms}
                onChange={(e) => setAgreedToTerms(e.target.checked)}
                className="w-4 h-4 mt-0.5 cursor-pointer accent-purple-600"
              />
              <span>
                Tôi đồng ý với{' '}
                <a href="#" className="text-purple-400 dark:text-purple-600 hover:text-purple-300 dark:hover:text-purple-700 transition-colors">
            ...
            <div className="relative text-center my-3">
              ...
              <span className="relative bg-gray-900 dark:bg-gray-50 px-4 text-gray-400 dark:text-gray-500 text-sm">Hoặc đăng ký với</span>
            </div>
