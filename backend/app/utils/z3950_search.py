...
def query_z3950(keyword: str, field: str):
    """Truy vấn tối đa 5 bản ghi từ Z39.50 LOC (Library of Congress)."""
    ...
    try:
        ...
        stdout, stderr = process.communicate(
            yaz_cmd.encode("utf-8"),
            timeout=getattr(Config, "Z3950_QUERY_TIMEOUT", 10),
        )
        ...
        return {"error": "Không tìm thấy chương trình yaz-client trong hệ thống."}
    except Exception as e:
        return {"error": f"Lỗi khi truy vấn LOC: {e}"}


def search_in_z3950(keyword: str, field: str = "any"):
    return query_z3950(keyword.strip(), field)
